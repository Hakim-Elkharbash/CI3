<div class="card-header">
	...
	<button class="btn btn-danger float-right mr-2" style="<?php if (count($users) == 0) echo 'display:none'; ?>" id="delAll">Delete All</button>
</div>
<div class="card-body">	
	<div class="row">
		<div class="col-md-12">
			...
			<table class="table table-striped" id="viewUsers">
				...
				<tbody>
					...
					<tr>
						...
						<td><?= $user->email;?></td>
						<td><?= $user->note;?></td>
						<td class="float-right"><a id="<?= $user->id;?>"><i class="fa-solid fa-trash-can fa-lg delUser"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?= base_url(); ?>"><i class="fa-solid fa-pencil fa-lg"></i></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
...
<div class="modal fade" id="deleteAllModal" tabindex="-1" role="dialog" aria-labelledby="deleteAllModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteAllModalLabel">Delete All Users</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
        <button type="button" id="ConfirmDeleteAll" class="btn btn-danger">Confirm (DELETE all users)</button>
      </div>
    </div>
  </div>
</div>